...
value class Matrix(
    ...
    fun getInvert(): Matrix{
        ...
        val invDet = 1.0f / det
        val res = Matrix()
        res[0, 0] = ((a11 * b11 - a12 * b10 + a13 * b09) * invDet)
        res[0, 1] = ((-a01 * b11 + a02 * b10 - a03 * b09) * invDet)
        res[0, 2] = ((a31 * b05 - a32 * b04 + a33 * b03) * invDet)
        res[0, 3] = ((-a21 * b05 + a22 * b04 - a23 * b03) * invDet)
        res[1, 0] = ((-a10 * b11 + a12 * b08 - a13 * b07) * invDet)
        res[1, 1] = ((a00 * b11 - a02 * b08 + a03 * b07) * invDet)
        res[1, 2] = ((-a30 * b05 + a32 * b02 - a33 * b01) * invDet)
        res[1, 3] = ((a20 * b05 - a22 * b02 + a23 * b01) * invDet)
        res[2, 0] = ((a10 * b10 - a11 * b08 + a13 * b06) * invDet)
        res[2, 1] = ((-a00 * b10 + a01 * b08 - a03 * b06) * invDet)
        res[2, 2] = ((a30 * b04 - a31 * b02 + a33 * b00) * invDet)
        res[2, 3] = ((-a20 * b04 + a21 * b02 - a23 * b00) * invDet)
        res[3, 0] = ((-a10 * b09 + a11 * b07 - a12 * b06) * invDet)
